  ...
  return (
    ...
    >
      ...
      <header className="page-header sticky top-0 z-50 border-b px-6 py-4 flex items-center gap-4 flex-wrap">
        <h1 className="page-title text-xl font-bold mr-auto">UI Component Gallery</h1>
      ...
      <main className="p-4 md:p-6">
        ...
        <section className={sectionCls("form")}>
          ...
          <div className={gridCls("grid-cols-1 md:grid-cols-2 lg:grid-cols-3")}>
            <DemoCard title="Buttons" style={st} theme={th} code={`<Button preset="${btnPreset}" variant="${btnVariant}">Click</Button>`}>
              <Row gap="8px" wrap>
            ...
            <DemoCard title="Input" style={st} theme={th} code={`<Input label="Name" placeholder="Enter name" />`}>
              <Column gap="8px">
            ...
            <DemoCard title="Toggle Switch" style={st} theme={th} code={`<Toggle label="Notifications" />`}>
              <Toggle style={st} theme={th} label="Notifications" checked={toggleVal} onCheckedChange={setToggleVal} />
            </DemoCard>

            <DemoCard title="Slider" style={st} theme={th} code={`<Slider min={0} max={100} label="Volume" />`}>
              <Slider style={st} theme={th} min={0} max={100} label="Volume" value={sliderVal} onValueChange={setSliderVal} />
            </DemoCard>

            <DemoCard title="Date Picker" style={st} theme={th} code={`<DatePicker format="YYYY-MM-DD" />`}>
              <Column gap="8px">
            ...
            <DemoCard title="File Upload" style={st} theme={th} code={`<FileUpload accept="image/*" />`}>
              <FileUpload style={st} theme={th} accept="image/*" label="Upload file" />
            </DemoCard>

            <DemoCard title="Dropdown Menu" style={st} theme={th} code={`<DropdownMenu items={items}><Button>Menu</Button></DropdownMenu>`}>
              <Row gap="8px">
                <DropdownMenu style={st} theme={th} items={dropdownItems}><Button style={st} theme={th}>Menu</Button></DropdownMenu>
              </Row>
            </DemoCard>

            <DemoCard title="Button Group" style={st} theme={th} code={`<ButtonGroup items={items} />`}>
            ...
            <DemoCard title="CodeEditor" style={st} theme={th} code={`<CodeEditor language="javascript" />`}>
              <Column gap="8px">
        ...
        <section className={sectionCls("layout")}>
          ...
          <div className={gridCls("grid-cols-1 md:grid-cols-2")}>
            <DemoCard title="Row / Column / Grid" style={st} theme={th} span="2" code={`<Row align="center" justify="between"><Column>…</Column></Row>`}>
            ...
            <DemoCard title="Accordion" style={st} theme={th} code={`<Accordion items={items} />`}>
              <Accordion style={st} theme={th} items={accordionItems} current="1" />
            </DemoCard>

            <DemoCard title="Carousel" style={st} theme={th} code={`<Carousel slides={slides} />`}>
              <Carousel style={st} theme={th} slides={carouselSlides} />
            </DemoCard>

            <DemoCard title="Modal" style={st} theme={th} code={`<Modal open={open} title="Hi">…</Modal>`}>
              <Row gap="8px">
            ...
            <DemoCard title="Drawer" style={st} theme={th} code={`<Drawer position="left" open={open}>…</Drawer>`}>
              <Row gap="8px">
            ...
            <DemoCard title="Command Palette" style={st} theme={th} code={`<CommandPalette groups={groups} />`}>
            ...
            <DemoCard title="Sortable List" style={st} theme={th} span="2" code={`<SortableList items={items}>{(item)=>…}</SortableList>`}>
              <Row gap="12px" fill>
                <Column gap="8px" fill>
        ...
        <section className={sectionCls("navigation")}>
          ...
          <div className={gridCls("grid-cols-1 md:grid-cols-2")}>
            <DemoCard title="Breadcrumb" style={st} theme={th} code={`<Breadcrumb items={items} />`}>
              <Breadcrumb style={st} theme={th} items={[{label:"Home",href:"#"},{label:"Products",href:"#"},{label:"Details"}]} />
            </DemoCard>
            <DemoCard title="Pagination" style={st} theme={th} code={`<Pagination total={50} perPage={10} />`}>
              <Pagination style={st} theme={th} total={50} perPage={10} current={paginationPage} onCurrentChange={setPaginationPage} />
            </DemoCard>
            <DemoCard title="Stepper" style={st} theme={th} span="2" code={`<Stepper steps={steps} current={2} />`}>
        ...
        <section className={sectionCls("datadisplay")}>
          ...
          <div className={gridCls("grid-cols-1 md:grid-cols-2 lg:grid-cols-3")}>
            <DemoCard title="Avatar" style={st} theme={th} code={`<Avatar size="md" fallback="AB" />`}>
              <Row gap="8px">
            ...
            <DemoCard title="Chip" style={st} theme={th} code={`<Chip color="primary">Tag</Chip>`}>
              <Row gap="8px" wrap>
            ...
            <DemoCard title="Tooltip" style={st} theme={th} code={`<Tooltip text="Hi"><Button>Hover me</Button></Tooltip>`}>
              <Tooltip style={st} theme={th} text="This is a tooltip!"><Button style={st} theme={th} variant="outlined">Hover me</Button></Tooltip>
            </DemoCard>
            <DemoCard title="Progress Bar" style={st} theme={th} code={`<ProgressBar value={65} animated label />`}>
              <Column gap="8px">
                <ProgressBar style={st} theme={th} value={progressVal} animated label />
                <ProgressBar style={st} theme={th} value={-1} />
              </Column>
            </DemoCard>
            <DemoCard title="Spinner" style={st} theme={th} code={`<Spinner size="md" />`}>
              <Row gap="12px">
            ...
            <DemoCard title="Skeleton" style={st} theme={th} code={`<Skeleton variant="text" />`}>
              <Column gap="8px">
            ...
            <DemoCard title="Table" style={st} theme={th} span="3" code={`<Table data={data} variant="striped" />`}>
        ...
        <section className={sectionCls("feedback")}>
          ...
          <div className={gridCls("grid-cols-1 md:grid-cols-2")}>
            <DemoCard title="Alert" style={st} theme={th} code={`<Alert preset="info" title="Heads up">…</Alert>`}>
            ...
            <DemoCard title="Toast" style={st} theme={th} code={`addToastMsg("Hi","success")`}>
              <Row gap="6px" wrap>
                {(["info","success","warning","error"] as const).map((p) => (
            ...
            <DemoCard title="Rating" style={st} theme={th} code={`<Rating max={5} showValue />`}>
              <Rating style={st} theme={th} max={5} showValue value={ratingVal} onValueChange={setRatingVal} />
            </DemoCard>
            <DemoCard title="Popover" style={st} theme={th} code={`<Popover content="Hi"><Button>Top</Button></Popover>`}>
              <Row gap="8px">
        ...
        <section className={sectionCls("charts")}>
          ...
          <div className={gridCls("grid-cols-1 md:grid-cols-2")}>
            <DemoCard title="Bar Chart" style={st} theme={th} code={`<BarChart data={[{label:"q1",value:12}]} />`}>
            ...
            <DemoCard title="Line Chart" style={st} theme={th} code={`<LineChart data={[{label:"Jan",revenue:10,Cost:5}]} />`}>
            ...
            <DemoCard title="Pie Chart" style={st} theme={th} code={`<PieChart data={[{label:"Direct",value:35}]} />`}>
            ...
            <DemoCard title="Doughnut Chart" style={st} theme={th} code={`<DoughnutChart options={{cutout:"60%"}} />`}>
            ...
            <DemoCard title="Radar Chart" style={st} theme={th} code={`<RadarChart data={[…]} />`}>
            ...
            <DemoCard title="Polar Area Chart" style={st} theme={th} code={`<PolarAreaChart data={[…]} />`}>
            ...
            <DemoCard title="Scatter Chart" style={st} theme={th} code={`<ScatterChart data={[{x:1,y:2}]} />`}>
            ...
            <DemoCard title="Bubble Chart" style={st} theme={th} code={`<BubbleChart series={[{label,x,y,r}]} />`}>
            ...
            <DemoCard title="Stacked Bar Chart" style={st} theme={th} code={`<StackedBarChart data={[…]} />`}>
            ...
            <DemoCard title="Stacked Line Chart" style={st} theme={th} code={`<StackedLineChart data={[…]} />`}>
